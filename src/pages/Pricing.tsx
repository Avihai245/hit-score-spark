...
const plans = [
  ...
  },
  {
    ...
    features: [
      ...
      { label: '10 AI remixes/month', included: true },
      { label: 'Full viral report + lyrics feedback', included: true },
      { label: 'Spotify playlist strategy', included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { label: 'Unlimited AI remixes', included: true },
      { label: 'API access (500 req/day)', included: true },
      { label: '3 team seats', included: true },
      { label: 'White-label reports', included: true },
      { label: 'Priority support + Slack', included: true },
    ],
  },
];
